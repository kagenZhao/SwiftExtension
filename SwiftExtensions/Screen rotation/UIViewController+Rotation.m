...
@property (nonatomic, copy) NSNumber *supportedInterfaceOrientations; // NSUInteger
@property (nonatomic, copy) NSNumber *preferredInterfaceOrientationForPresentation; // NSInteger
@property (nonatomic, copy) NSNumber *preferredStatusBarStyle; // NSInteger
...
/*
 ...
 优先级为 UIViewController < UIViewController(Category) < UINavigationController/UITabBarController < UINavigationController(Category)
 */
